...
//   //check history for questions
//   const checkQuestionHistory = useCallback((question) => {
...
//       latestRecord.isCorrect === true
//     ) {
//       return { hasHistory: true, status: "completed", record: latestRecord };
//     }

//     // Nếu đang làm dở hoặc đã sai -> hiển thị với trạng thái unanswered
//     if (
//       latestRecord.status === "unanswered" ||
//       latestRecord.isCorrect === false
//     ) {
//       return { hasHistory: true, status: "unanswered", record: latestRecord };
//     }

//     // Mặc định
//     return {
//       hasHistory: true,
//       status: latestRecord.status || "not-started",
//       record: latestRecord,
//     };
//   }, []);
...
//       }
//     }, 1500);
//   }, [currentQuestion, getNextQuestionTime, videoRef]);
...
//       if (lectureId && moduleItemId && dispatch) {
//         console.log("incorrect answer submitted to backend:", currentQuestion);
//       }
//     } catch (error) {
