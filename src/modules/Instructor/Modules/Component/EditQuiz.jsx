...
import {
  ...
  editQuizByItemId,
} from "~/store/slices/ModuleItem/action";
      ...
      <StyledCard>
        ...
        <CardContent sx={{ p: 3 }}>
          ...
          {hasChanges && !isLoading && (
            <Alert severity="info" sx={{ mb: 3 }} icon={<EditIcon />}>
              You've made changes to this quiz. Don't forget to save your
              changes!
            </Alert>
          )}
                          ...
                          label={
                            ...
                            >
                              <Star
                                fontSize="small"
                                color={
                                  quizData.isGrade ? "primary" : "disabled"
                                }
                              />
                      ...
                      <StyledTextField
                        ...
                        onChange={(e) =>
                          handleQuizChange("duration")({
                            target: {
                              value: parseInt(e.target.value) * 60 || 0,
                            },
                          })
                        }
