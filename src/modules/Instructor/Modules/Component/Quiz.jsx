...
const Quiz = () => {
    ...
    const handleCancel = () => {
        if (quizData.title || quizData.description || quizData.questions.some(q => q.content)) {
            if (window.confirm('Are you sure you want to cancel creating this quiz? All your changes will be lost.')) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const result = await dispatch(createModuleItemQuiz({ courseId, moduleId, quizData }));
