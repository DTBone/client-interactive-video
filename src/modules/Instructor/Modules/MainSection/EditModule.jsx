  ...
  return (
    <div className="bg-gray-50 py-8 px-4 min-h-[80vh] flex items-start">
      <ModuleFormCard elevation={3}>
        <CardHeaderStyled
          ...
          action={
            <Tooltip title="Return to modules" placement="top">
              <IconButton color="inherit" onClick={handleCancel} size="large">
                <ArrowBack />
              </IconButton>
            </Tooltip>
          }
        ...
        <CardContent>
          {hasChanges && (
            <Alert severity="info" sx={{ mb: 3 }} icon={<Edit />}>
              You've made changes to this module. Don't forget to save your
              updates!
            </Alert>
          )}
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <StyledTextField
                  ...
                  helperText={
                    formErrors.title ||
                    "A descriptive title helps students understand the module content"
                  }
              ...
              <Grid item xs={12}>
                <StyledTextField
                  ...
                  helperText={
                    ...
                    "Optional: A good description helps students understand the module's learning objectives"
                  }
            ...
            >
              ...
              <Box sx={{ display: "flex", gap: 2 }}>
                ...
                <ActionButton
                  ...
                  color="primary"
                  disabled={
                    isSubmitting || !formData.title.trim() || !hasChanges
                  }
                  startIcon={<Save />}
                >
