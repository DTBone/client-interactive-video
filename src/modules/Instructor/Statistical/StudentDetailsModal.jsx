                        ...
                        <Box sx={modalStyle}>
                            ...
                            <div className="mb-4">
                                ...
                                <div className="flex items-center space-x-3">
                                    <LinearProgress
                                        variant="determinate"
                                        value={studentProgress?.completionPercentage ? studentProgress.completionPercentage : 0}
                                        className="flex-grow"
                                    />
                                    <Typography variant="body2">
                                        {studentProgress?.completionPercentage ? studentProgress.completionPercentage : 0}%
                                    </Typography>
                                </div>
                                <div className="mt-2 flex space-x-3">
                                    <Chip
                                        label={`Average Score: ${studentProgress.averageScore ? studentProgress.averageScore : 0}%`}
                                        color="primary"
                                        variant="outlined"
                                    />
                                    <Chip
